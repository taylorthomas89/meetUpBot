...
MeetupBot.prototype._replyWithMeetUps = function (originalMessage) {
  ...
  //self.postMessageToChannel(channel.name, outputEvents(), {as_user: true});
};
...
MeetupBot.prototype._isFromMeetupBot = function (message, user) {
